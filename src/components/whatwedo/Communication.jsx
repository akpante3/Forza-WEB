        ...
        <div className="communication what-we-do-container" ref={ref}>
                ...
                <div className="what-we-do__image">
                    <div style={ {position: 'relative', width: '100%'}}>
                        <div className={[ animate ? 'communication__thought' : 'dont-display' ].join(' ')}>
                        ...
                        { animate ? (<img className="communication__image" src={require('../../icons/images/image-4-on.png')} alt="comms-image" />) : (<img className="communication__image" src={require('../../icons/images/image-4.png')} alt="comms-image2" />)}
                    </div>
                </div>
                <div className="what-we-do-container__text communication__text">
                    <div className="list__number"><span className={['list__number__figures', 'list__number__figures--three', animate ? 'list__number__figures--animate-in' : 'list__number__figures--animate-out' ].join(' ')}>3</span></div>
                    ...
                    <ul className="what-we-do-container__text__details__body"> 
                        <li>
                            ...
                            <div className={[animate ? 'animate-list-item--on' : 'animate-list-item'].join(' ')}>
                                <p >Digital Marketing</p>
                            </div>
                        </li>
                        <li><div className="communication__text__icon"><PublicRelations /></div> <p>Public Relations</p></li>
                        <li><div className="communication__text__icon"><SocialMedia /></div> <p>Social Media Management</p>  </li>
                    </ul>
                    </div>                  
                </div>
        </div>
