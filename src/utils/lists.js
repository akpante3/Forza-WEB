export const aboutNavList = [
    { name: 'Who we are', link: '/about/who-we-are' }, 
    { name: 'Philosophy', link: '/about/philosophy' }, 
    { name: 'Thinking', link: '/about/thinking' }, 
    { name: 'Workflow', link: '/about/workflow' },
    {name: 'Clients', link: '/about/clients'}
]
...
{ name: 'Communications', link: '/services/communition' },
